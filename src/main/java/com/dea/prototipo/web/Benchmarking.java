...
public class Benchmarking {
    ...
    public String benchmarking(Model uiModel) {
        ...
        uiModel.addAttribute("bodegas", Warehouse.findWarehousesByUser(user).getResultList());
    ...
    ResponseEntity<String> solver(@RequestParam(value = "warehouse") Long bodegaId) {
        ...
        try {
            ...
            if (tester.getEfficiencyStatus(aux)) {
                ...
                proyeccion = "Por lo tanto se concluye que su warehouse trabaja de manera completamente eficienciente.";
            ...
            if (testerO.getEfficiencyStatus(aux)) {
                ...
                proyeccionO = "Por lo tanto se concluye que su warehouse trabaja de manera completamente eficienciente.";
